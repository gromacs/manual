...
Christoph Junghans, Peter Kasson, Per Larsson, \\
Peiter Meulenhoff, Teemu Murtola, Szil\'ard P\'all, \\
Sander Pronk, Roland Schulz, Michael Shirts, \\
Alfons Sijbers, and Peter Tieleman \\}
\vspace{5mm}
...
Mark Abraham, Jochen Hub, Carsten Kutzner, Brad Lambeth, \\
Justin A. Lemkul, Erik Marklund, and Maarten Wolf.
\end{center}
...
\href{http://www.gnu.org/copyleft/lesser.html}{www.gnu.org/copyleft/lesser.html}.
