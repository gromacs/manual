...
\end{itemize}
The coarse-grained representation of the interaction is stored as tabulated interaction funtion see \secref{userpot}. The convention is to use the $C^{(12)}$  columns with the  $C^{(12)}$ coefficient set to 1. All other columns should be zero.\\
