...
\subsection{\normindex{Intramolecular pair interaction}s}
...
LJ interactions in the solute. This second step can be combined with
...
\subsection{\normindex{Implicit Solvent parameters}}
...
morse		& {\tts bonds}$^{(excl,con)}$ & 2 & 3	& $b_0$ (nm); $D$ (\kJmol); $\beta$ (nm$^{-1}$) & all \\
...
LJ/C. pair NB	& {\tts pairs_nb}	      & 2 & 1	& $q_i$, $q_j$ (e); $V^{(cr)}$; $W^{(cr)}$ &    \\
...
Urey-Bradley    & {\tts angles}$^{(con)}$     & 3 & 4	& $\theta_0$ (deg); $k_\theta$ (\kJmol); $r_{13}$ (nm); & \\
                &                             &   &     & $k_{UB}$ (\kJmolnm{-2}) & all \\
...
vsite2		& {\tts virtual_sites2}	& 3 & 1	& $a$ ()					& 	\\
vsite3		& {\tts virtual_sites3}	& 4 & 1	& $a$, $b$ ()				& 	\\
vsite3fd	& {\tts virtual_sites3}	& 4 & 2	& $a$ (); $d$ (nm)				& 	\\
vsite3fad	& {\tts virtual_sites3}	& 4 & 3	& $\theta$ (deg); $d$ (nm) 		& 	\\
vsite3out	& {\tts virtual_sites3}	& 4 & 4	& $a$, $b$ (); $c$ (nm$^{-1}$) 		& 	\\
vsite4fdn	& {\tts virtual_sites4}	& 5 & 2	& $a$, $b$ (); $c$ (nm);	   		& 	\\
vsite COG 	& {\tts virtual_sitesn}	& 1 & 1	& one or more construc. atom ind.   		& 	\\
vsite COM	& {\tts virtual_sitesn}	& 1 & 2	& one or more construc. atom ind.   		& 	\\
vsite COW  	& {\tts virtual_sitesn}	& 1 & 3	& one or more pairs consisting of	& 	\\
                &                               &   &   & a construc. atom ind. and weight           &       \\
position res.	& {\tts position_restraints}   & 1 & 1	& $k_{x}$, $k_{y}$, $k_{z}$ (\kJmolnm{-2}) & all	\\
restr. pot.	& {\tts bonds}		        & 2 & 10	& low, up$_1$, up$_2$ (nm);             & all	\\
               	&                   	        &   &  	& $k_{dr}$ (\kJmolnm{-2})               & 	\\
distance res.	& {\tts distance_restraints}   & 2 & 1	& type; label; low, up$_1$, up$_2$ (nm); & \\
                &                               &   &   & weight () & \\
dihedral res.   & {\tts dihedral_restraints}   & 4 & 1  & $\phi_0$ (deg); $\Delta\phi$ (deg); & $k$ (\kJmolnm{-2}) & all \\
...
(see \secref{group} and \secref{groups}).
...
restraints (\secref{posre}) by {\tt \#include}-ing an {\tt .itp} file whose contents
