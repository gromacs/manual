...
\label{sec:fbposres}
Flat-bottomed position restraints can be used to restrain particles to a
certain volume of the simulation box. Within the flat-bottomed volume of
the flat-bottomed potential, no force acts on the restrained
particle. Only as the particle leaves the boundary of the flat-bottomed
volume, a harmonic force pulls the particle
back into the unrestrained region. It is possible to apply normal and
...
It is possible to apply two independent flat-bottomed position
...
unrestrained region, leading to a potential that keeps the particle {\it outside} of the volume
