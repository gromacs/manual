...
\index{force-field, coarse-grainded}
...
\end{itemize}
\item Conserving distributions (like the radial distribution function)
\begin{itemize}
...
offer implementation of the above algorithms, i.e. the \normindex{VOTCA package}, which
