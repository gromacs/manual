...
required for P3M and it can derive the forces by analytical differentiation
...
This means the advantage of error minimization in P3M-AD can be used
at the same computational cost and with the same code as PME,
by just adding a few lines to modify the influence function.
