...
A coarse-grained force field is not just one specific force-field (a set of parameter), but a set of (mostly tabulated) interactions, 
made in way, that the coarse-grained system (less degrees of freedom) reproduces certain properties of an underlying high resoulution system 
(many degrees of freedom), which can be an atomistic system or even an experimental course of setup.
